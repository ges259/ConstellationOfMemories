...
struct MyFontColor {
    // 하나의 텀의 개수
    private let term1 = 10
    private lazy var term2 = 10 + term1
    private lazy var term3 = 10 + term2
    private lazy var term4 = 10 + term3
    private lazy var term5 = 10 + term4
    private lazy var term6 = 10 + term5
    private lazy var term7 = 10 + term6
    private lazy var term8 = 10 + term7
    // 모든 Font_Color의 개수
    lazy var term9 = 10 + term8
    
    
    
    mutating func fontColor(index: Int) -> UIColor {
        if index < self.term1 {
            switch index {
            ...
            case 10: return UIColor.rgb(r: 255, g: 255, b: 255)
                
            default: return UIColor.rgb(r: 255, g: 255, b: 255)
            }
            
        } else if index < self.term2 {
            switch index + 40 {
